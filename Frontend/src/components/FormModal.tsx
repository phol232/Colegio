...
export const btnOutlineSecondary =
    'inline-flex items-center justify-center gap-1.5 rounded-lg border border-secondary bg-white px-3 py-2 text-sm font-medium text-secondary transition-colors hover:bg-secondary/5 focus:outline-none focus:ring-2 focus:ring-secondary/30 dark:border-slate-600 dark:bg-slate-800 dark:text-slate-200 dark:hover:bg-slate-700';
...
export const FormModal = ({ isOpen, onClose, title, subtitle, icon, children, footer }: FormModalProps) => {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div className="relative w-full max-w-md overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-2xl dark:border-slate-700 dark:bg-slate-800">
                <ModalCloseButton onClose={onClose} />
                <div className="border-b border-slate-100 px-6 py-5 pr-12 dark:border-slate-700">
