...
export const COURSE_COLORS: { [key: string]: { primary: string; light: string; border: string } } = {
  ...
  'matemática': { primary: '#4F46E5', light: '#EEF2FF', border: '#4F46E5' },
  'geometria': { primary: '#0891B2', light: '#ECFEFF', border: '#0891B2' },
  'geometría': { primary: '#0891B2', light: '#ECFEFF', border: '#0891B2' },
  'aritmetica': { primary: '#2563EB', light: '#EFF6FF', border: '#2563EB' },
  'aritmética': { primary: '#2563EB', light: '#EFF6FF', border: '#2563EB' },
  'algebra': { primary: '#7C3AED', light: '#FAF5FF', border: '#7C3AED' },
  'álgebra': { primary: '#7C3AED', light: '#FAF5FF', border: '#7C3AED' },
  'estadistica': { primary: '#475569', light: '#F8FAFC', border: '#475569' },
  'estadística': { primary: '#475569', light: '#F8FAFC', border: '#475569' },
  'trigonometria': { primary: '#4338CA', light: '#EEF2FF', border: '#4338CA' },
  'trigonometría': { primary: '#4338CA', light: '#EEF2FF', border: '#4338CA' },
  ...
  'historia del perú': { primary: '#C2410C', light: '#FFF7ED', border: '#C2410C' },
  'etica': { primary: '#0D9488', light: '#F0FDFA', border: '#0D9488' },
  'ética': { primary: '#0D9488', light: '#F0FDFA', border: '#0D9488' },
  'etica y ciudadania': { primary: '#0D9488', light: '#F0FDFA', border: '#0D9488' },
  'ética y ciudadanía': { primary: '#0D9488', light: '#F0FDFA', border: '#0D9488' },
  'ciudadania': { primary: '#0D9488', light: '#F0FDFA', border: '#0D9488' },
  'ciudadanía': { primary: '#0D9488', light: '#F0FDFA', border: '#0D9488' },
  'economia': { primary: '#059669', light: '#F0FDF4', border: '#059669' },
  'economía': { primary: '#059669', light: '#F0FDF4', border: '#059669' },
  
  // Ciencias Naturales
  'biologia': { primary: '#16A34A', light: '#F0FDF4', border: '#16A34A' },
  'biología': { primary: '#16A34A', light: '#F0FDF4', border: '#16A34A' },
  'quimica': { primary: '#C026D3', light: '#FDF4FF', border: '#C026D3' },
  'química': { primary: '#C026D3', light: '#FDF4FF', border: '#C026D3' },
  
  // Otros
  'educacion fisica': { primary: '#65A30D', light: '#F7FEE7', border: '#65A30D' },
  'educación física': { primary: '#65A30D', light: '#F7FEE7', border: '#65A30D' },
  'talleres': { primary: '#EA580C', light: '#FFF7ED', border: '#EA580C' },
  'computacion': { primary: '#0284C7', light: '#F0F9FF', border: '#0284C7' },
  'computación': { primary: '#0284C7', light: '#F0F9FF', border: '#0284C7' },
  'ingles': { primary: '#DB2777', light: '#FDF2F8', border: '#DB2777' },
  'inglés': { primary: '#DB2777', light: '#FDF2F8', border: '#DB2777' },
