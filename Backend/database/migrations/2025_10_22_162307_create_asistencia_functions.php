...
return new class extends Migration
{
    ...
    {
        DB::unprepared("
            DROP FUNCTION IF EXISTS registrar_asistencia_masiva;
            DROP FUNCTION IF EXISTS obtener_resumen_asistencia;
            DROP FUNCTION IF EXISTS obtener_asistencias_curso;
            DROP FUNCTION IF EXISTS obtener_asistencias_estudiante;
            DROP FUNCTION IF EXISTS actualizar_asistencia;
        ");
    }
};
